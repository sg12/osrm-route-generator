...
const terminals = {
  central: [55.036200, 82.898331],       // Россия, Новосибирск, ЖД Вокзал
  gusinobrodskiy: [55.041116, 83.027464] // тот же адрес — если нужно разделить, уточни адрес центрального
};
...
const routesData = [
  ...
  { coords: [terminals.gusinobrodskiy, [54.412019, 86.312055]], name: 'Новосибирск → Белово', terminal: 'gusinobrodskiy' },
